...
export const houseCallForKidsContent: ContentPage = {
  title: "HouseCall For Kids",
  description: "Telehealth urgent care for children and young adults",
  sections: [
    {
      type: "hero",
      content: {
    ...
    },
    {
      type: "info",
      content: {
        title: "Staffed by Dr. Nash",
        description: "Staffed by Dr. Nash on evenings and weekends, HouseCall For Kids can troubleshoot and treat a variety of problems all from the comfort of your home, car, or wherever you are.",
    ...
    },
    {
      ...
      content: {
        ...
        description: "Simple payment options and easy scheduling available.",
        cta: {
    ...
    },
    {
      type: "features",
      content: {
        title: "Why Choose HouseCall For Kids?",
        features: [
          {
            title: "No Waiting Room Exposure",
            description: "Avoid sitting in crowded urgent care waiting rooms and reduce exposure to other illnesses."
          },
          {
            title: "Convenient Access",
            description: "Get care from anywhere - your home, car, or wherever you happen to be."
          },
          {
      ...
      content: {
        features: [
          ...
          },
          {
            ...
            description: "Yes, it is. Everything we do at 1-to-1 Pediatrics and HouseCall For Kids is aimed at making access to quality, comforting healthcare easier to obtain. This is just the latest addition."
          }
        ]
      }
    },
    {
      ...
      content: {
        title: "Click To Schedule",
        description: "Have more questions? Check out our FAQ above or schedule your telehealth urgent care visit now.",
        cta: {
          text: "Click To Schedule",
          href: "https://housecallforkids.com/schedule"
        }
