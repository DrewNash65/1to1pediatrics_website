  ...
  sections: [
        ...
        features: [
          {
            ...
            description: "Pam has been Dr. Nash's 'right hand' for the past 22 years and is the office manager for 1-to-1 Pediatrics/Danville Pediatrics. She has the experience in pediatrics to get authorizations approved while simultaneously calming the nerves of an anxious child. As the 'Jill-of-all-trades' for 1-to-1 Pediatrics, Pam is the person who can get things done. Feel free to call or email her with your questions."
          },
          {
          ...
          {
            title: "Kasie - Medical Assistant",
            description: "Kasie is the newest addition to the office team and comes with years of experience as a medical assistant. She has a friendly and down-to-earth demeanor with patients and families. She's a quick problem solver and we're thrilled to have her with us."
          }
        ]
      }
    },
    ...
    },
    {
      ...
      content: {
        ...
        description: "Learn more about Dr. Nash and Dr. Borden.",
        cta: {
