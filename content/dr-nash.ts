  ...
  sections: [
    ...
    },
    {
      ...
      content: {
        ...
        description: "Dr. Nash is a fellow of the American Academy of Pediatrics and a diplomate of the American Board of Pediatrics. He is on staff at John Muir Medical Center in Walnut Creek and has been practicing primary care pediatrics in the San Ramon Valley for over 25 years."
      }
    },
    {
      type: "info",
      content: {
        ...
        description: "Dr. Nash has completed rigorous training in concussion management and has been granted the status of Credentialed ImPACT Consultant. He is the only primary care pediatrician in California to achieve this certification, making 1-to-1 Pediatrics the East Bay ImPACT Center for comprehensive concussion management."
      }
    },
    {
      type: "info",
